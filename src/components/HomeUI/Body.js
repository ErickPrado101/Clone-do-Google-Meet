...
const Body = () => {
  ...
  return (
    <BodyContainer>
      <BodyLeft>
        <h1>
          Videochamadas premium.<br /> Agora gratuitas para todos
        </h1>
        <h3>
        Reformulamos o Google Meet, nosso serviço seguro para reuniões de negócios.<br />
        Agora ele é aberto e gratuito para todos. 
        </h3>
        ...
        <BodyButtons>
          ...
          <RightButtons>
            <div>
              ...
              <input
                type='text'
                placeholder='Entre com o código ou link'
                ref={inputText}
                value={callInput}
                onChange={(e) => {
        ...
        <LearnMore>
          <a
            ...
            rel='noreferrer'
          >
            <span>Leia mais</span> sobre o GOOGLE MEET
          </a>
        </LearnMore>
      </BodyLeft>
      <BodyRight>
